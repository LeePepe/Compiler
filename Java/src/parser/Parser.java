...
public class Parser {
    ...
    Expr factor() throws IOException {
        ...
        switch (look.tag) {
            ...
            case Tag.ID:
                ...
                Id id = top.get(look); // ?? top.get(s);
                if (id == null) error(look.toString() + " factor undeclared");
                move();
    ...
    Access offset(Id id) throws IOException {
        Expr index, w, t1, t2, loc;
        // 数组下标，类型宽度（算偏移量），临时1，临时2，所需的目标数组变量
        Type type = id.type;
